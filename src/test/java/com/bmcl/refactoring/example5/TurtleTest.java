...
public class TurtleTest {
    ...
    public void testRotateLeft() {
        ...
        turtle.execute('L');
        assertTrue(turtle.getDirection() instanceof TurtleWest);
        turtle.execute('L');
        assertTrue(turtle.getDirection() instanceof TurtleSouth);
        turtle.execute('L');
        assertTrue(turtle.getDirection() instanceof TurtleEast);
        turtle.execute('L');
        assertTrue(turtle.getDirection() instanceof TurtleNorth);
